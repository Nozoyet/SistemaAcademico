...
export default function ReporteEstudiantes() {
  ...
  const descargar = (formato) => {
    ...
    window.open(`${api.defaults.baseURL}/docente/reportes/estudiantes/${formato}?${params}`, "_blank");
  };

  return (
    <div className="p-6 space-y-6">
      <h1 className="text-2xl font-bold">Reporte de estudiantes</h1>
      ...
      <div className="bg-white p-5 rounded-lg shadow grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <input name="nombre" placeholder="Nombre estudiante" value={filtros.nombre} onChange={change} className="border p-2 rounded" />
